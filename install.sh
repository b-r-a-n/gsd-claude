...
echo "Next steps:"
echo ""
echo -e "  ${YELLOW}1. Configure permissions (recommended):${NC}"
echo ""
echo "     To run GSD without approval prompts, copy the settings template:"
echo ""
echo "     # For global setup (all projects):"
echo "     cp ~/.claude/commands/gsd/docs/settings-global.json ~/.claude/settings.json"
echo ""
echo "     # Or for per-project setup:"
echo "     cp ~/.claude/commands/gsd/docs/settings-project.json .claude/settings.local.json"
echo ""
echo "     See docs/PERMISSIONS.md for detailed options."
echo ""
echo "  2. Start Claude Code in your project directory"
echo ""
echo "  3. Create your first GSD project:"
echo "     /gsd:commands:new-project"
echo ""
echo "  4. Plan your first phase:"
echo "     /gsd:commands:plan-phase 1"
echo ""
echo "  5. Execute the phase:"
